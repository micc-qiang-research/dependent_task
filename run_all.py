...
def rename(k, ccr, lfr, dcr):
    file = f"__result__/app30-new/data_{k}_{ccr}_{lfr}_{dcr}.pkl"
    with open(file, 'rb') as handle:
        ...
        # df.rename(columns={'makespan_Proposed': 'Proposed'}, inplace=True)
        ...
        df.rename(columns={'Propose': 'Proposed'}, inplace=True)
